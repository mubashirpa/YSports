...
public class IntentUtil {
    ...
    public static void addPlaybackPropertiesToIntent(@NonNull MediaItem.LocalConfiguration localConfiguration, @NonNull Intent intent, String extrasKeySuffix) {
        intent.putExtra(MIME_TYPE_EXTRA + extrasKeySuffix, localConfiguration.mimeType)
                .putExtra(AD_TAG_URI_EXTRA + extrasKeySuffix, localConfiguration.adsConfiguration != null ? localConfiguration.adsConfiguration.adTagUri.toString() : null);
    ...
    public static void addDrmConfigurationToIntent(@NonNull MediaItem.DrmConfiguration drmConfiguration, @NonNull Intent intent, String extrasKeySuffix) {
        ...
        String[] drmKeyRequestProperties = new String[drmConfiguration.licenseRequestHeaders.size() * 2];
        int index = 0;
        ...
        List<@C.TrackType Integer> forcedDrmSessionTrackTypes = drmConfiguration.forcedSessionTrackTypes;
        if (!forcedDrmSessionTrackTypes.isEmpty()) {
            // Only video and audio together are supported.
            Assertions.checkState(forcedDrmSessionTrackTypes.size() == 2
    ...
    public static void addClippingConfigurationToIntent(@NonNull MediaItem.ClippingConfiguration clippingConfiguration, Intent intent, String extrasKeySuffix) {
    ...
    public static void addToIntent(List<MediaItem> mediaItems, Intent intent) {
        ...
        if (mediaItems.size() == 1) {
            ...
            for (int i = 0; i < mediaItems.size(); i++) {
                ...
                addPlaybackPropertiesToIntent(localConfiguration, intent, "_" + i);
                addClippingConfigurationToIntent(mediaItem.clippingConfiguration, intent, "_" + i);
                if (mediaItem.mediaMetadata.title != null) {
